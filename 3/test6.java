...
public class test6 {
    public static void main(String[] args) {
        ...
        float weightKuresb = scanner.nextFloat();

        System.out.print("Enter your height (cm): ");
        float heightKuresb = scanner.nextFloat();
        heightKuresb = heightKuresb/100;

        float index = weightKuresb / (heightKuresb * heightKuresb);
